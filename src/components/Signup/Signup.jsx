...
const Login = () => {
  ...
  const onsubmit = () => {
    axios.post("http://localhost:8080/registration", {"name" : name, "email_id" :user, "password": password})
  ...
  return (
    <div className={styles.login}>
      ...
      <div className={styles.form}>
        <center><h2 className={styles.formheading}>Create an account</h2></center>
        <form action="">
          ...
          {/* <button className={style.searchButton} onClick={handleClickSearch}>
                 <Link to="/Login" className={style.searchLink}>SEARCH</Link>
          </button> */}
        </form>
      </div>
